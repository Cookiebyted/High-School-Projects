...
-----------------------------------------------------------------------------------------------------------
	...
	local aboutRectangle = display.newRect( centerX, centerY + 20, 300, 300 )
		aboutRectangle.strokeWidth = 3
		aboutRectangle:setFillColor(243,243,243)
		aboutRectangle:setStrokeColor( 0, 0, 0)
		sceneGroup:insert(aboutRectangle)
	
	local aboutText = display.newText( "Made by Matthew Young", aboutRectangle.x, aboutRectangle.y, "Merriweather.ttf", 16 )

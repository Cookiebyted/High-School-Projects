...
local learnTopics = {"Inequalities", "Simultaneous Equations", "Like Terms", "Polynomials", "One-Step Equations", "Two-Step Equations", "Expanding", "Factorising", "Quadratic Equations", "Discriminants" }
----------------------------------------------------------------------
--	Scene Methods
----------------------------------------------------------------------
...
function scene:create( event )
	...
	local title = display.newText("Learn", centerX, secondBar.y + 50, "Merriweather.ttf", 26)
...
----------------------------------------------------------------------------------------------	
	local function onRowRender(event)
		...
		-- Display row names
		local rowTitle = display.newText(row, learnTopics[row.index], 0, 0, "Merriweather.ttf", 14 )
		...
		local function onObjectTap(event)
			...
			composer.gotoScene("scenes.learnScenes.learn" .. event.id, options)
			return true
		end
			row.tap = onObjectTap
